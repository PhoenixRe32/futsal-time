	...
	<div class='settings_frame' width='100%' style='margin:10px 15px 10px 15px;'>
		<table id='manager_settings' width='100%' style='padding:0px 20px 10px 20px;'>
			...
			<tr>
				...
				<td width='275px' style='padding-left:20px;'>
					<select <?php if ( $_SESSION['smsC_P'] == '0' ) echo "disabled='disabled'" ?> class='settings' id='smsC' style='width:100%;'>
			...
			<tr>
				...
				<td width='275px' style='padding-left:20px;'>
					<select <?php if ( $_SESSION['smsM_P'] == '0' ) echo "disabled='disabled'" ?> class='settings' id='smsM'  style='width:100%;'>
