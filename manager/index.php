<?php
include_once('./scripts/php/levelcontrol.php');
?>
...
<div class="bubble">
	<div title="Opening Image" style="position:relative; text-align:center; padding-top:20px; margin-bottom:20px;">
		<img src="images/bannerManager.jpg" alt="banner" />
	</div>

	<div style="position:relative; text-align:center;">
		<div id='login_form'>
			<input type='hidden' name='login_form_focused' id='login_form_focused' value='0'/>
			<label hidden='hidden' for="login_arena"> &nbsp &nbsp &nbsp Arena: </label>
				<input type="text" name="login_arena" id="login_arena" size="24" value='THOI' hidden='hidden'/>
