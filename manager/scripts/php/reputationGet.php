...
foreach ( $members as $m )
{
	...
	if ( trim($m['name']) == '')
		$html .= "
				<td id='{$m['phone']}_name' align='left' style='cursor:pointer; border-bottom-style:none; line-height:2.5' onclick=\"updateRepName('{$m['phone']}')\">{$m['name']}</td>";
	else
		$html .= "
				<td id='{$m['phone']}_name' align='left' style='border-bottom-style:none; line-height:2.5' >{$m['name']}</td>";
	$html .= "
				<td align='center' style='border-bottom-style:none; line-height:2.5'>{$m['phone']}</td>
				<td align='center' style='border-bottom-style:none; line-height:2.5'><a href='mailto:{$m['email']}'>Send</a></td>
				<td align='center' style='border-bottom-style:none; line-height:2.5'>";
	...
	$html .= "
				...
				<td align='center' style='border-bottom-style:none;'><span id='{$m['phone']}_notes'>{$m['notes']}</span><img src='./images/edit-16.png' style='cursor:pointer;' onclick=\"updateRepNotes('{$m['phone']}', '{$aernaid}')\" /></td>
				</td>
				<td align='center' style='border-bottom-style:none;'><img src='./images/delete.jpg' style='cursor:pointer;' onclick=\"removeMember('{$m['phone']}', '{$aernaid}')\" /></td>
