...
function removeMember(customerPhone) {
	alert('Disabled temporarily');return;
	var value = confirm("Are you certain you want to remove this member from the database?");
	if ( value == false ) return;
	
	var request = $.ajax({
		type	: 'POST',
		url		: './scripts/php/removeMember.php',
		data	: { p : customerPhone },
		dataType:	'json'
	});
