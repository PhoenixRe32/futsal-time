<?php
	...
	$links['booking'] = ( $_GET['caller'] == 'booking' ) ? "<li><a id='onlink' href='index.php?caller=booking'>{$lang['TAB_BOOK']}</a></li>" : "<li><a href='index.php?caller=booking'>{$lang['TAB_BOOK']}</a></li>"; 
